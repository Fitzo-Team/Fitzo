...
public class ImageAvatarServiceTests
{
    ...
    public async Task UpdateUserAvatarAsync_ShouldDeleteOldAvatar_WhenUserHasOne()
    {
        ...
        var service = new ImageAvatarService(profileServiceMock.Object, userManagerMock.Object);
        ...
        userManagerMock.Verify(x => x.UpdateAsync(
            It.Is<UserIdentity>(u => u.AvatarUrl != oldAvatarFileName && u.AvatarUrl == result)), 
            Times.Once);
    }
}